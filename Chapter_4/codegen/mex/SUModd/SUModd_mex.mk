...
MAKEFILE = SUModd_mex.mk

include SUModd_mex.mki
...
MEX_FILE_NAME_WO_EXT = SUModd_mex
...
SYS_INCLUDE += -I"C:\Users\sulaymon.eshkabilov\Documents\MATLAB\MY_MATLAB_Book\Chapter_4\codegen\mex\SUModd"
SYS_INCLUDE += -I"C:\Users\sulaymon.eshkabilov\Documents\MATLAB\MY_MATLAB_Book\Chapter_4"
...
%.$(OBJEXT) : C:\Users\sulaymon.eshkabilov\Documents\MATLAB\MY_MATLAB_Book\Chapter_4/%.c
	$(CC) -Fo"$@" $(CFLAGS) "$<"

%.$(OBJEXT) : C:\Users\sulaymon.eshkabilov\Documents\MATLAB\MY_MATLAB_Book\Chapter_4\codegen\mex\SUModd/%.c
	$(CC) -Fo"$@" $(CFLAGS) "$<"
